"""Test fixture for dual-region deployment with regional routing."""
...
FIXTURE_NAME = "mrpn-regional-routing"
...
def test_network(networks_client: compute_v1.NetworksClient, project_id: str) -> None:
    ...
    assert result.routing_config.routing_mode == "REGIONAL"
