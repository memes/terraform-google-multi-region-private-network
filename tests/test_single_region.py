...
FIXTURE_NAME = "mrpn-single-region"
...
def test_subnetwork(subnetworks_client: compute_v1.SubnetworksClient, project_id: str) -> None:
...
def test_routers(routers_client: compute_v1.RoutersClient, project_id: str) -> None:
