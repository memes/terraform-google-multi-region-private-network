"""Test fixture for dual-region deployment with flow logging every minute."""
...
FIXTURE_NAME = "interval-flow-log"
FIXTURE_LABELS = {
...
def test_subnetwork_us_west1(
    ...
    assert result.log_config.aggregation_interval == "INTERVAL_1_MIN"
