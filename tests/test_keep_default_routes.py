"""Test fixture for dual-region deployment but keep the default routes."""
...
FIXTURE_NAME = "mrpn-keep-default-routes"
...
def test_routes(routes_client: compute_v1.RoutesClient, project_id: str) -> None:
    ...
    for route in default_routes:
        assert re.search("default-route-[0-9a-f]{16}$", route.name)
